...
std::string windowTitle = "Jaden Hepburn 100791169";
...
int main() {
	...
	static const GLfloat points[] = {
		-0.5f * shifter, -0.5f * shifter, 0.5f *shifter,
		0.5f * shifter, -0.5f * shifter, 0.5f * shifter,
		-0.5f * shifter, 0.5f * shifter, 0.5f * shifter
	};
